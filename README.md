  Esse projeto se baseia em um simples CRUD utilizando o framework Django como backend de site. Trata-se de um CRUD, que é capaz de criar categorias e
...
python, para permitir a renderização das imagens.
  ...
  O models, classe que vai servir para definir as tabelas de produtos e de categorias, possui seus próprios atributos, sendo separado em categorias, que possuias seguintes colunas:
